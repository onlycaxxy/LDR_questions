    ...
    <header className="border-b border-slate-10 bg-white/100 backdrop-blur-md sticky top-0 z-50">
      <div className="container mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          <span className="text-xl font-bold tracking-tight bg-gradient-to-r from- to-blue-700 to-white-100 bg-clip-text text-transparent">LDR questions to bondᯓ★</span>
        </Link>
